...
public class FieldDetection{
    ...
    public FieldDetection(){
        ...
        propertiesHashMap.put(18,new Properties("Luxury Tax",0));
        propertiesHashMap.put(19,new Properties("BoardWalk",400));
        propertiesHashMap.put(600,new Properties("START",0));
        ...
        propertiesHashMap.put(480,new Properties("Income Tax",0));
